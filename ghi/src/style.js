const styles = {
    ...
    heading: `font-poppins font-semibold xs:text-[48px] text-[40px] 
    text-white xs:leading-[76.8px] leading-[66.8px] w-full`,
    paragraph: `font-poppins font-normal text-slate-300 text-[18px] 
    leading-[30.8px]`,
...
export const layout = {
    ...
    sectionReverse: `flex md:flex-row 
    flex-col-reverse ${styles.paddingY}`,
